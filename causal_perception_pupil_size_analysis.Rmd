...
#down sampling to 50hz using median values:
...
```{r}
ggplot(data = exp.data.pupil.processed.downsampled%>% filter(condition != "hab"), aes(x = bin_low, y =pupil.base.corrected.binned )) +
  ylab("Pupil size") +
  xlab("Time (in ms)") +
